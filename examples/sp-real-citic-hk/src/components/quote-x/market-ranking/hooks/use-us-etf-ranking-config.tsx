...
export interface UseUSETFRankingConfigOptions {
  blocks?: number[];
}

function useUSETFRankingConfig({ blocks }: UseUSETFRankingConfigOptions) {
  ...
  const columns = useMemo(() => {
    const basicColumnWidth = Math.floor(window.innerWidth * 0.2);
...
export default useUSETFRankingConfig;
