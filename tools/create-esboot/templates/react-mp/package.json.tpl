{
  ...
  "scripts": {
    "esboot": "esboot",
    "dev": "esboot dev",
    "dev:rspack": "cross-env ESBOOT_BUNDLER=rspack esboot dev",
    "build": "pnpm run build:rspack",
    "build:rspack": "cross-env ESBOOT_BUNDLER=rspack esboot build",
    "build:ci": "pnpm run test && pnpm run build",
    "test": "esboot vitest",
  ...
  "dependencies": {
    ...
    "@dz-web/esboot-browser-react": "^4.4.6",
    "@dz-web/o-orange": "^4.6.5",
  ...
  "devDependencies": {
    "@dz-web/esboot": "^4.4.6",
    "@dz-web/esboot-bundler-rspack": "^4.4.6",
    "@dz-web/esboot-bundler-vite": "^4.4.6",
    "@dz-web/esboot-plugin-vitest": "^4.4.6",
  ...
  "esbootTemplateGitHash": "33cb1fbc0229042e6f7a52869f1f524b97df2824"
}